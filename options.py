...
def args_parser():
    ...
    parser.add_argument('--epoch', type=int, default=300,
                        help="the number of epochs of original method: E")
    ...
    parser.add_argument('--lr', type=float, default=0.001,
                        help='learning rate')
    parser.add_argument('--w_d', type=float, default=0.004,
                        help='weight_decay')
    ...
    parser.add_argument('--mu', type=float, default=0.1,
                        help='The mu in fedprox which controls the weight of proximal term in loss function')
    ...
    parser.add_argument('--num_classes', type=int, default=10, help="number \
                        of classes")
    parser.add_argument('--num_train', type=int, default=50000, help="number \
                            of train")
